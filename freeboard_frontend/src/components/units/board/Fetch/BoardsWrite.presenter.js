      ...
      <Container>
        <Head>
          ...
          <Head_body>
            <Head_body_left>
              ...
              <Body_detail>{props.data?.fetchBoard?.contents}</Body_detail>
            </Head_body_left>
            <Head_body_center>
              <Body_youtube
                src={props.data?.fetchBoard?.youtubeUrl}
              ></Body_youtube>
              {/* <Body_youtube src="https://www.youtube.com/embed/5pRIDXQJxzw"></Body_youtube> */}
              <Body_Like>
                <Like_left>
        ...
        <Body>
          <Body_Btn>
            ...
            <Body_Btn_update onClick={props.onClickContents}>
              수정하기
            </Body_Btn_update>
